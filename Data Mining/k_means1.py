...
#for line in open('data1.txt').readlines():
    tweets.append(line)
...
cluster = []
# Print tweets that belong to cluster 1,2,3,4,5
for idx, cls in enumerate(km.labels_):
    if cls == 0:
        a=open("cluster1.txt",'a')
        a.write(tweets[idx])
        a.write("\n")
        cluster.append(tweets[idx])
    if cls == 1:
        a=open("cluster2.txt",'a')
        a.write(tweets[idx])
        a.write("\n")
        cluster.append(tweets[idx])
    if cls == 2:
        a=open("cluster3.txt",'a')
        a.write(tweets[idx])
        a.write("\n")
        cluster.append(tweets[idx])
    if cls == 3:
        a=open("cluster4.txt",'a')
        a.write(tweets[idx])
        a.write("\n")
        cluster.append(tweets[idx])
    if cls == 4:
        a=open("cluster5.txt",'a')
        a.write(tweets[idx])
        a.write("\n")
        cluster.append(tweets[idx])
